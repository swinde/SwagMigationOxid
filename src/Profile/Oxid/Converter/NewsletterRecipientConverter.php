...
use Swag\MigrationOxid\Profile\Oxid19\Premapping\Oxid19NewsletterRecipientStatusReader;
...
abstract class NewsletterRecipientConverter extends OxidConverter
{
    /**
     * @var string
     */
    ...
    private function getStatus(array $data): ?string
    {
        $status = $this->mappingService->getValue(
            $this->connectionId,
            Oxid19NewsletterRecipientStatusReader::getMappingName(),
            $data['subscriber_status'],
            $this->context
        );
