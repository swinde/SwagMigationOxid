...
use Swag\MigrationOxid\Profile\Oxid\Premapping\ShippingMethodReader;
...
abstract class SalesChannelConverter extends OxidConverter
{
    ...
    public function __construct(OxidMappingServiceInterface $mappingService, LoggingServiceInterface $loggingService)
    {
    ...
    public function convert(array $data, Context $context, MigrationContextInterface $migrationContext): ConvertStruct
    {
        ...
        if (isset($data['storeViews'])) {
            ...
            $this->mappingService->createListItemMapping(
                $this->connectionId,
                OxidDefaultEntities::STORE_DEFAULT,
                '0',
                $this->context,
                null,
                $converted['id']
         ...
         */
        $countryUuid = $this->mappingService->getOxidCountryUuid(
            $data['defaultCountry'],
            $this->connectionId,
            $context
        );
    ...
    protected function getSalesChannelCountries(string $countryUuid, array $data, Context $context): array
    {
        ...
        if (isset($data['countries'])) {
            foreach ($data['countries'] as $country) {
                $uuid = $this->mappingService->getOxidCountryUuid(
                    $country,
                    $this->connectionId,
                    $context
                );
