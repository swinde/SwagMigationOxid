...
use Swag\MigrationOxid\Migration\Mapping\OxidMappingServiceInterface;
use Swag\MigrationOxid\Profile\Oxid\DataSelection\DefaultEntities as OxidDefaultEntities;
use Swag\MigrationOxid\Profile\Oxid\Premapping\OrderDeliveryStateReader as OxidOrderDeliveryStateReader;
use Swag\MigrationOxid\Profile\Oxid\Premapping\PaymentMethodReader;
use Swag\MigrationOxid\Profile\Oxid19\Premapping\Oxid19OrderStateReader;
use Swag\MigrationOxid\Profile\Oxid19\Premapping\Oxid19SalutationReader;
...
{
    /**
     * @var OxidMappingServiceInterface
     */
    ...
    public function __construct(
        OxidMappingServiceInterface $mappingService,
    ...
    protected function getSalutation(string $salutation): ?string
    {
        $salutationMapping = $this->mappingService->getMapping(
            $this->connectionId,
            Oxid19SalutationReader::getMappingName(),
            $salutation,
            $this->context
        );
    ...
    protected function getDeliveries(array $data, array $converted): array
    {
        ...
        foreach ($data['shipments'] as $shipment) {
            ...
            $deliveryStateMapping = $this->mappingService->getMapping(
                ...
                OxidOrderDeliveryStateReader::DEFAULT_SHIPPED_STATUS,
                $this->context
            );
    ...
    protected function convertOrderCustomer(array &$converted, array &$data): bool
    {
        ...
        if (isset($data['orders']['customer_id']) && $data['orders']['customer_is_guest'] === '0') {
            ...
            $guestCustomerMapping = $this->mappingService->getOrCreateMapping(
                $this->connectionId,
                OxidDefaultEntities::GUEST_CUSTOMER,
        ...
        if ($guestOrder === true) {
            ...
            $languageMapping = $this->mappingService->getMapping(
                $this->connectionId,
                OxidDefaultEntities::STORE_LANGUAGE,
    ...
    protected function convertOrderStatus(array &$converted, array &$data): bool
    {
        $stateMapping = $this->mappingService->getMapping(
            $this->connectionId,
            Oxid19OrderStateReader::getMappingName(),
    ...
    private function getDefaultDelivery(array &$data, array &$converted): void
    {
        ...
        $deliveryStateMapping = $this->mappingService->getMapping(
            $this->connectionId,
            OrderDeliveryStateReader::getMappingName(),
            OxidOrderDeliveryStateReader::DEFAULT_OPEN_STATUS,
            $this->context
        );
