...
use Swag\MigrationOxid\Profile\Oxid\DataSelection\DefaultEntities as OxidDefaults;
...
abstract class CategoryConverter extends OxidConverter
{
    /**
     * @var string
     */
    ...
    public function convert(array $data, Context $context, MigrationContextInterface $migrationContext): ConvertStruct
    {
        ...
        // Ignore the Oxid root category
        if (isset($data['parent_id']) && $data['parent_id'] === '0') {
            $mapping = $this->mappingService->getOrCreateMapping(
                $this->connectionId,
                OxidDefaults::ROOT_CATEGORY,
                $data['entity_id'],
                $this->context
            );
        ...
        $rootCategoryMapping = $this->mappingService->getMapping($this->connectionId, OxidDefaults::ROOT_CATEGORY, $data['parent_id'], $context);
