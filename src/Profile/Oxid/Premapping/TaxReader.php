...
use Swag\MigrationOxid\Profile\Oxid\DataSelection\ProductDataSelection;
use Swag\MigrationOxid\Profile\Oxid\DataSelection\ProductReviewDataSelection;
use Swag\MigrationOxid\Profile\Oxid\DataSelection\SeoUrlDataSelection;
...
abstract class TaxReader extends AbstractPremappingReader
{
    ...
    {
        /** @var Oxid19LocalGateway $gateway */
