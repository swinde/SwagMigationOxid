...
namespace Swag\MigrationOxid\Profile\Oxid\Media;
...
use Swag\MigrationOxid\Exception\MediaPathNotReachableException;
...
class LocalMediaProcessor extends BaseMediaService implements MediaFileProcessorInterface
{
    ...
    {
        return $migrationContext->getProfile() instanceof Oxid19Profile
