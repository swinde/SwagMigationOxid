...
abstract class ProductMultiSelectPropertyRelationReader extends AbstractReader
{
    /**
     * @var int
     */
...
SQL;
        ...
        return new TotalStruct(DefaultEntitiesAlias::PRODUCT_MULTI_SELECT_PROPERTY, $total);
    }
...
INNER JOIN {$this->tablePrefix}catalog_product_entity_varchar AS entity_varchar ON  entity_varchar.entity_id = product.entity_id
