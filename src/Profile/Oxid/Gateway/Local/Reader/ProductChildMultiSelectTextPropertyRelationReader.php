...
SQL;
        ...
        return new TotalStruct(DefaultEntitiesAlias::PRODUCT_CHILD_MULTI_SELECT_TEXT_PROPERTY, $total);
    }
...
INNER JOIN {$this->tablePrefix}catalog_product_entity_text AS entity_text ON entity_text.entity_id = relation.child_id
