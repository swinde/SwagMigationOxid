...
abstract class ProductPropertyRelationReader extends AbstractReader
{
    /**
     * @var int
     */
...
INNER JOIN {$this->tablePrefix}catalog_product_entity_int AS entity_int ON entity_int.entity_id = product.entity_id
